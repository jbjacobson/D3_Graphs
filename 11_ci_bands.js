...
var models = [
    ...
    {interactive:true, legendPosition:'right', dataDisplays:{symbols:false, line:true, area:false, ci:true}, title:{text:"Confidence interval", position:"left"}, yAxis:{label:"Y Axis Label"}}
]
