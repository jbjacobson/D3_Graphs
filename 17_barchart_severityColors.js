...
var models = [
    {title:"color bars based on value",sort:"name", axisLabel:{text:"Frequency"},colorByValue:{colors:highSeverityColors, thresholds:[.04,.08]}},
    {title:"inverse colors for low alarms (same thresholds)",sort:"value",inverted:true, axisLabel:{text:"custom axis label"},colorByValue:{colors:lowSeverityColors, thresholds:[.04,.08]}},
    {},
    {}
];
