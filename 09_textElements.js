...
var models = [
    {interactive:false, legendPosition:'right', dataDisplays:{line:true, area:true}},
    {interactive:true, legendPosition:'left', dataDisplays:{symbols:true, line:true}, title:"This is a graph title", yAxis:{suffix:'GB', label:"Y Axis Label"}}
]
...
function timeSeries(pe, m, d){
    ...
    ts.draw = function(){
        ...
        var leftMargin = 40; //TODO: make this dynamic based on yAxis width
